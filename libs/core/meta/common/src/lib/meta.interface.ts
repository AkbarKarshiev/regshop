...
export const META_CONFIG_DEFAULT: MetaConfig = {
  ...
  description: $localize`:Meta default|:Regshop sportswear, shoes and accessories. Free delivery in Tashkent and all over Uzbekistan when paying on the website.`,
