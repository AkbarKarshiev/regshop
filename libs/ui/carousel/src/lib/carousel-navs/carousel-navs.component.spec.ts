...
@Component({
  template: `<regshop-carousel-navs automation-id="carousel-navs"></regshop-carousel-navs>`
})
...
describe('CarouselNavsComponent', () => {
  ...
  it('should call prev after click prev', () => {
    const prev = jest.spyOn(pageObject.carouselNavs?.componentInstance.prev, 'emit');
